...
CLEAR
	縺吶∋縺ｦ縺ｮ譁・ｭ怜・蝙句､画焚縺ｨ謨ｴ謨ｰ蝙矩・蛻励ｒ遐ｴ譽・＠縲∵紛謨ｰ蛟､繧抵ｼ舌→縺吶ｋ縲ゅ∪縺溘・
	PCG縺ｮ菴ｿ逕ｨ繧偵ｄ繧√∬｡ｨ遉ｺ繧ｭ繝｣繝ｩ繧ｯ繧ｿ繝ｼ繧偵Μ繧ｻ繝・ヨ縺吶ｋ縲・
*/
...
int lib_display(int r0, int r1, int r2){
	...
	switch(r2){
		...
		case DISPLAY_SCROLL:
			//SCROLL x,y
			//	逕ｻ髱｢繧呈ｨｪ譁ｹ蜷代√ｂ縺励￥縺ｯ邵ｦ譁ｹ蜷・譁懊ａ繧ょ庄)縺ｫ蜍輔°縺吶ょ虚縺九☆譁ｹ蜷代→螟ｧ縺阪＆
			//	縺ｯ縲』, y縺ｧ縺昴ｌ縺槭ｌ縲∵ｨｪ譁ｹ蜷代・遘ｻ蜍募ｺｦ縲∫ｸｦ譁ｹ蜷代・遘ｻ蜍募ｺｦ縺ｨ縺励※謖・ｮ壹☆繧九・
			// TODO: here
			break;
		case DISPLAY_WIDTH:
			//WIDTH x
			//	繧ｭ繝｣繝ｩ繧ｯ繧ｿ繝ｼ繝・ぅ繧ｹ繝励Ξ繧､縺ｮ讓ｪ蟷・ｒ譁・ｭ玲焚縺ｧ謖・ｮ壹Ｙ縺ｯ30縲・6縲・0縲・8縲・
			//	繧ゅ＠縺上・80縲・
			break;
		case DISPLAY_TVRAM:
